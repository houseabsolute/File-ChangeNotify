...
https://metacpan.org/release/File-ChangeNotify

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends File::ChangeNotify
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends File::ChangeNotify
...
The code for this distribution is [hosted at GitHub](https://github.com/autarch/File-ChangeNotify).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=File-ChangeNotify)
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.58.
